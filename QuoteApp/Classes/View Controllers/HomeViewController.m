...
@interface HomeViewController () <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UICollectionViewDataSource, UICollectionViewDelegate, CLLocationManagerDelegate>
...
- (IBAction)pressSearch {
    ...
    // already have one.
    NSLog(@"Loc services? %d", [CLLocationManager locationServicesEnabled]);
